        ...
        <fieldset class="bg-gray-100 border border-gray-300 rounded p-2 mb-4 mt-5">
          ...
          <div class="table w-full border-separate border-spacing-2 table-fixed">
            <div class="table-row bg-gray-200 font-semibold">
              ...
              <div class="table-cell p-1">Acciones</div>
            </div>
            ...
            <button
              ...
              @click="eliminarMateriales(index)"
            >
...
const eliminarMateriales = (index) => {
  filasMateriales.value.splice(index, 1)
  console.log("Material eliminado en el índice:", index)
}
