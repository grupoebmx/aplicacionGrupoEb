...
const guardarProcesoCompleto = async (proceso, datosBD, claveStorage) => {
  try {
    ...
    switch (proceso) {
      case 'recepcion':
        respuesta = await axios.post('https://backendgrupoeb.onrender.com/api/recepcion/insertar', datosBD)
        break
      case 'impresion':
        respuesta = await axios.post('https://backendgrupoeb.onrender.com/api/impresion/insertar', datosBD)
        break
      case 'suaje':
        respuesta = await axios.post('https://backendgrupoeb.onrender.com/api/procesosuaje/insertar', datosBD)
        break
      case 'pegado':
        respuesta = await axios.post('https://backendgrupoeb.onrender.com/api/pegado/insertar', datosBD)
        break
      case 'armado':
        respuesta = await axios.post('https://backendgrupoeb.onrender.com/api/armado/insertar', datosBD)
        break
      case 'almacen':
        respuesta = await axios.post('https://backendgrupoeb.onrender.com/api/procesoalmacen/insertar', datosBD)
        break
      case 'calidad':
        respuesta = await axios.post('https://backendgrupoeb.onrender.com/api/calidad/insertar', datosBD)
        break
      case 'envio':
        respuesta = await axios.post('https://backendgrupoeb.onrender.com/api/envio/insertar', datosBD)
        break
    }
...
const cargarImagenes = async () => {
  try {
    ...
    const response = await fetch(`https://backendgrupoeb.onrender.com/api/imagenes-orden/${noOrden}`)
...
const cargarChoferes = async () => {
  try {
    ...
    const response = await fetch('https://backendgrupoeb.onrender.com/api/usuarios/rol/Chofer')
...
function validarRolAutorizacion(rolUsuario, proceso, tipo) {
  const permisos = {
    ...
    pegado: {
      pc: ['Calidad', 'Direccion'],
      operador: ['Operador'],
    },
    armado: {
      ac: ['Calidad', 'Direccion'],
      operador: ['Operador'],
    },
    almacen: {
      operador: ['Operador'],
    ...
    calidad: {
      ec: ['Calidad', 'Direccion'],
      ea: ['Administrador', 'Direccion'],
    },
    envio: {
      operador: ['Operador'],
...
async function validarUsuario(numEmpleado, password) {
  try {
    ...
    const response = await axios.post('https://backendgrupoeb.onrender.com/api/auth/validar-usuario', {
...
const obtenerDatosOrdenPDF = async (no_orden) => {
  try {
    ...
    const response = await fetch(`https://backendgrupoeb.onrender.com/api/produccion/info-pdf/${no_orden}`)
...
const obtenerFolioConsecutivoCalidad = async () => {
  try {
    const response = await fetch('https://backendgrupoeb.onrender.com/api/folios/calidad')
    if (!response.ok) {
...
const obtenerDatosCompletosCertificado = async (no_orden) => {
  try {
    ...
    const responseCliente = await fetch(`https://backendgrupoeb.onrender.com/api/ordenes-cliente/${no_orden}`)
    ...
    const responseProducto = await fetch(
      `https://backendgrupoeb.onrender.com/api/produccion/certificado/${no_orden}`,
    )
...
const obtenerProductoProduccion = async (no_orden) => {
  try {
    loading.value = true
    const response = await axios.get(`https://backendgrupoeb.onrender.com/api/produccion/detalle/${no_orden}`)
...
const obtenerEstadoOrden = async () => {
  try {
    const response = await axios.get(`https://backendgrupoeb.onrender.com/api/ordenproduccion/${pedidoId.value}`)
  ...
  try {
    ...
    if (procesosCompletos) {
      ...
      const response = await axios.put(
        `https://backendgrupoeb.onrender.com/api/ordenproduccion/${pedidoId.value}/completar`,
      )
